...
Generate TypeScript or Python type definitions for all Composio tools. These types provide type safety when using `composio.tools.execute()`, helping you pass the correct parameters and catch errors early.
