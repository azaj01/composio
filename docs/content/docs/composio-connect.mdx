...
<ConnectClientOption id="chatgpt" name="ChatGPT" description="OpenAI's AI assistant" icon="/images/clients/chatgpt.png" category="other">
...
<ConnectClientOption id="notion" name="Notion" description="AI-powered workspace with custom agents" icon="/images/clients/notion.svg" category="other">
...
<ConnectClientOption id="agent-builder" name="Agent Builder" description="OpenAI Agent Builder" icon="/images/clients/chatgpt.png" category="other">
...
<ConnectClientOption id="mcp-url" name="MCP URL" description="For any MCP client" icon="/images/clients/mcp.svg" category="other">
