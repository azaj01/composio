...
<Callout type="info">
For most use cases, we recommend using [Tool Router](/docs/quickstart). Tool Router provides dynamic tool access and a much better MCP experience with context management done by us.
</Callout>
