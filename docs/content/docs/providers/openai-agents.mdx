...
OpenAI Agents SDK is a lightweight framework for building agentic AI apps with minimal abstractions.
...
<Tab value="Python">
```python
# TODO: Native tools Python code
```
</Tab>
<Tab value="TypeScript">
```typescript
// TODO: Native tools TypeScript code
```
</Tab>
</Tabs>
</Step>
...
<Tab value="Python">
```python
# TODO: MCP Python code
```
</Tab>
<Tab value="TypeScript">
```typescript
// TODO: MCP TypeScript code
```
</Tab>
</Tabs>
</Step>
...
TODO: Direct tool usage content
</Accordion>

<Accordion title="Direct MCP usage">
TODO: Direct MCP usage content
</Accordion>
</Accordions>
