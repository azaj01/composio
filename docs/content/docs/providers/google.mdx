...
keywords: [gemini, google genai]
---

The Google Gen AI provider transforms Composio tools into a format compatible with [Gemini's function calling](https://ai.google.dev/gemini-api/docs/function-calling) capabilities.
...
let response = await chat.sendMessage({
    message: "Star the composiohq/composio repository on github",
});
