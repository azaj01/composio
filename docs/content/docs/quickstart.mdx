...
<Callout type="info">
- Set `COMPOSIO_API_KEY` from [Settings](https://platform.composio.dev/?next_page=/settings)
- Set `OPENAI_API_KEY` from [OpenAI](https://platform.openai.com/api-keys)
</Callout>
...
<Callout type="info">
- Set `COMPOSIO_API_KEY` from [Settings](https://platform.composio.dev/?next_page=/settings)
- Set `ANTHROPIC_API_KEY` from [Anthropic](https://console.anthropic.com/settings/keys)
</Callout>
