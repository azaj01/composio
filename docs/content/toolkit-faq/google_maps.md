...
Common causes: user revoked access, password/2FA change, Workspace admin policy changes, or refresh‑token limits (~50 tokens). Reauthorization generally resolves 401s.
