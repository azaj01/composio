...
| Endpoint | Quick Link |
|----------|------------|
| `GET /api/v3/cli/realtime/credentials` | [Get credentials for CLI realtime events](/reference/api-reference/triggers/getCliRealtimeCredentials) |
| `POST /api/v3/cli/realtime/auth` | [Authenticate CLI Pusher channel access](/reference/api-reference/triggers/postCliRealtimeAuth) |
