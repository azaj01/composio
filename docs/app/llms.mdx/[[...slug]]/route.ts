...
async function generateToolkitsIndex(): Promise<string> {
  ...
  const lines: string[] = [
    ...
    '',
    '- [Premium Tools](/toolkits/premium-tools.md) - Learn about pricing and limits',
    '- [Composio Managed Auth](/toolkits/managed-auth.md) - Check which toolkits have managed auth',
    '',
    '## All Toolkits',
    '',
