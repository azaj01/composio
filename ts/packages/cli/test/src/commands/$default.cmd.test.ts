      ...
      Effect.gen(function* () {
        ...
        expect(yield* sanitize(output)).toMatchInlineSnapshot(`
          ...
          Environment Variables:
            ...
            - triggers status [--user-ids text] [--connected-account-ids text] [--toolkits text] [--trigger-ids text] [--trigger-names text] [--show-disabled] [--deprecated-connected-account-uuids text] [--limit integer]  Show active triggers with optional filters.
